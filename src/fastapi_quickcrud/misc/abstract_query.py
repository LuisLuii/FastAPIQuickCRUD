...
class SQLAlchemyPostgreQueryService(object):
...
class SQLAlchemyGeneralSQLQueryService(object):
    ...
    def get_many(self, *,
        ...
        stmt = session.query(*[model] + join_table_instance_list).filter(and_(*filter_list))
        if order_by_columns:
            order_by_query_list = []
...
#
# class SQLAlchemySQLQueryService(object):
#
#     def __init__(self, *, model, async_mode):
#
#         """
