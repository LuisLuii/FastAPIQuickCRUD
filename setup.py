...
if __name__ == '__main__':
    setup(
        ...
        version=VERSION,
        install_requires=["fastapi<=0.73.0","pydantic<=1.9.0","SQLAlchemy<=1.4.31","StrEnum==0.4.7","starlette==0.18.0",
                          "aiosqlite==0.17.0"],
        tests_require=["uvicorn==0.17.1", "greenlet==1.2.2", "anyio==3.5.0"],
        python_requires=">=3.7",
